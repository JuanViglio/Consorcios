            ...
            <table>
                <tr>
                    ...
                    <td style="width: 643px; height: 226px;">
                        <asp:GridView ID="grdGastosOrdinarios" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="150px" OnRowCommand="grdGastosOrdinarios_RowCommand" style="margin-top: 0px; margin-left: 0px;" Width="622px">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 643px">
                        <asp:GridView ID="grdGastosEventuales" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="150px" style="margin-top: 0px; margin-left: 0px;" Width="622px">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="Detalle" HeaderText="Detalle">
                                <ItemStyle Font-Bold="False" Font-Names="Calibri" Font-Size="Large" ForeColor="#8888A5" />
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <div class="div_parent">
                                            <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" CommandName="Eliminar" ImageUrl="~/assets/img/ico_eliminar.png" ToolTip="Modificar" />
                                        </div>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="Label8" runat="server" Text="Total:   $" Font-Size="Large" style="color: #003399"></asp:Label>
                                </td>
                                <td style="width: 97px">
                                    <asp:Label ID="lblTotalGastosEventuales" runat="server" Font-Size="Large" style="color: #003399"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br />
