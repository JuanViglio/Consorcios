<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GastoExtraordinario.aspx.cs" Inherits="WebSistemmas.Consorcios.GastosExtraordinario" MasterPageFile ="~/Consorcios/MenuConsorcios.Master"%>
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 100px; height: 51px">
                                            <asp:Button ID="btnAgregarGastoExtraordinario" runat="server" Height="30px" OnClick="btnAgregarGastoextraordinario_Click" Text="Agregar" Width="90px" />
                                        </td>
                                        <td style="height: 51px; width: 100px;">
                                            <asp:Button ID="btnCancelarGastoExtraordinario" runat="server" Height="30px" OnClick="btnCancelarGastoExtraordinario_Click" Text="Cancelar" Width="90px" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
