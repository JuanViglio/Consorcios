<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ingreso.aspx.cs" Inherits="WebSistemmas.Ingreso" %>
...
<input type="password" name="password" placeholder="••••••••••••" class="text" style="background:url(images/password.png) no-repeat;" />
